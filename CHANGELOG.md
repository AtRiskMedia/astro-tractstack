...
- Upgraded astro and all packages

#### [2.4.1] - 2026-6-24

### Changed

- UX improvements for shopify

### Added

- /cart/reset path for debug
...
- service-bound shopify products
- tenant-scoped emails
- logout domain cookie on sites using subdomain

### Added

- product sales dashboards
- local pick-up products listed in booking emails
...
- mobile menu
- allow delete of creative pane
- shopify max booking length enforcement
...
- enhanced shopify integration, removed cal.com integration, built native calendar booking system

#### [2.3.0] - 2026-2-10

### Added

- shopify and cal.com booking integration

#### [2.2.10] - 2026-1-31

### Fixed

- isDirty on add template pane

#### [2.2.9] - 2026-1-16

### Fixed

- on delete pane properly update storyfragment

#### [2.2.8] - 2026-1-16

### Added

- delete and reorder panes
